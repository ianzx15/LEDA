 ...
 *  - isEmpty() - diz se a heap eh vazia ou nao
 *   
 * @author Adalberto
 *
 */
public interface HeapMerge{
	 ...
	 * - Voce pode usar apenas os metodos add(), poll() e isEmpty() da heap.
	 * 
	 ...
	 * - Voce pode usar apenas os métodos poll() e isEmpty() da heap.
	 * 
